<?php
    ...
    $query = "SELECT product_id, product_name, product_size,stock_quantity, product_mat, product_type, SUM(stock_quantity) AS stock
                        ...
                        while($row = mysqli_fetch_array($productResult, MYSQLI_BOTH)){
                            ...
                            echo'
                                ...
                                <div class = "container" id = "container ' . $row['product_id'] . '" style = "position: fixed; height: 430px; display: none;">
                                    <form method = "post" action = "export.php" style = "width: 100%; margin-top: 0;">
                                        ...
                                        <div class = "text">
                                            ...
                                            <div class = "stock-group" style = "height: 82px;">
                                                ...
                                                <div>
                                                    <input type = "number" name = "remove_stock" min = "1" value = '.$remove_stock.'>
                                                </div>
                                            ...
                                            <div class = "button-container">
                                                <button a href = "withdrawStock.php" class = "save-button" onclick = "validateInput(event)" style = "width: 120px;">Withdraw</button>
